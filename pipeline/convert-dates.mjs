...
const INPUT_FILE = path.join(ANALYZED_DIR, 'analyzed-v4-all.json');
const OUTPUT_FILE = path.join(ANALYZED_DIR, 'analyzed-v4-all-dated.json');
...
const PRE_FILES = [
  path.join(REVIEWS_DIR, 'reviews-v3-inkout-austin-tx.pretatt2away.json'),
  path.join(REVIEWS_DIR, 'reviews-v3-inkout-chicago-il.pretatt2away.json'),
  path.join(REVIEWS_DIR, 'reviews-v3-inkout-draper-ut.pretatt2away.json'),
  path.join(REVIEWS_DIR, 'reviews-v3-inkout-houston-tx.pretatt2away.json'),
];
